...
parser.add_argument('--work_save', default='None')
...
####### for fish
parser.add_argument('--n_global_head', type=int, default=None)
parser.add_argument('--name_method', type=str, default=None)
...
with open(os.path.join(args.work_save, 'model.pt'), 'rb') as f:
